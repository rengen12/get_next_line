int		main(int ac, char **av)
{
	...
	if (ac >= 2)
	{
        ...
        ft_putendl_fd("file1 | out10:", to_check);
        res = get_next_line(fd, &str);
        ft_putstr_fd("res = ", to_check);
        ft_putnbr_fd(res, to_check);
        ft_putendl_fd("", to_check);
        ...
        ft_putendl_fd("file2(last) | out11:", to_check);
        res = get_next_line(fd1, &str);
        ft_putstr_fd("res = ", to_check);
        ft_putnbr_fd(res, to_check);
        ft_putendl_fd("", to_check);
        ...
        ft_putendl_fd("file2(nothing) | out13:", to_check);
        res = get_next_line(fd1, &str);
        ft_putstr_fd("res = ", to_check);
        ft_putnbr_fd(res, to_check);
        ft_putendl_fd("", to_check);
        ...
        ft_putendl_fd("file1(nothing) | out15:", to_check);
        res = get_next_line(fd, &str);
        ft_putstr_fd("res = ", to_check);
        ft_putnbr_fd(res, to_check);
        ft_putendl_fd("", to_check);
        ...
        ft_putendl_fd("file3 | out23:", to_check);
        res = get_next_line(fd2, &str);
        ft_putstr_fd("res = ", to_check);
        ft_putnbr_fd(res, to_check);
        ft_putendl_fd("", to_check);
        ...
        ft_putendl_fd("file3 | out24:", to_check);
        res = get_next_line(fd2, &str);
        ft_putstr_fd("res = ", to_check);
        ft_putnbr_fd(res, to_check);
        ft_putendl_fd("", to_check);
        ...
        ft_putendl_fd("file3 | out25:", to_check);
        res = get_next_line(fd2, &str);
        ft_putstr_fd("res = ", to_check);
        ft_putnbr_fd(res, to_check);
        ft_putendl_fd("", to_check);
        ...
        ft_putendl_fd("file2 over1 | out27:", to_check);
        res = get_next_line(fd1, &str);
        ft_putstr_fd("res = ", to_check);
        ft_putnbr_fd(res, to_check);
        ft_putendl_fd("", to_check);
